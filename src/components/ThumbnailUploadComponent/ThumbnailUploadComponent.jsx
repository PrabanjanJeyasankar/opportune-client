...
const ThumbnailUploadComponent = ({ thumbnail, handleInputChange, error }) => {
  ...
  return (
    <div className={styles.thumbnail_upload}>
      ...
      <label htmlFor="thumbnail_upload" className={styles.thumbnail_label}>
        {thumbnail ? (
          ...
          <span className={styles.thumbnail_placeholder}>Upload Thumbnail</span>
        )}
      </label>
      ...
      {isModalOpen && (
        ...
        >
          ...
          <ImageComponent
            ...
            className="thumbnail_preview w-full h-full object-cover rounded-lg"
          />
        </Modal>
      )}
    </div>
